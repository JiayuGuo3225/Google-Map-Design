...
class TrojanMap {
 public:
  ...
  void Brute_Force_helper(std::vector<std::string> &points, std::vector<std::vector<std::string>> &res, 
  ...
  void Backtracking_helper(std::vector<std::string> &points, std::vector<std::vector<std::string>> &res, 
  ...
  void Move_3_opt(std::vector<std::string> &location_ids, int i, int j, int k, int opt3_case, int M);
  
  void Reverse_segment(std::vector<std::string> &n, int start_index, int end_index);

  int Tourindex(std::vector<std::string> &v, std::string s);
